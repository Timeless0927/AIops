...
def _ledger(tmp_path: Path, gate_id: str, *, run_id: str = "run-controller-uid-1",
        ...
        if predecessor == "V05":
            ...
            artifacts.append(evidence.write_json("V06", "recovery.json", {
                ...
                "telemetry": {
                    ...
                    "recovery_log_observed_at": 1305.0, "recovery_log_ref_hashes": ["f" * 64],
                },
            }))
...
def _attest(evidence: AcceptanceEvidence, gate_id: str, review_sha256: str) -> None:
