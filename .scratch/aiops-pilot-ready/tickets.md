...
当前 live candidate（A01）：`dist/aiops-pilot-v0.1.0.tar.gz` SHA256 `689d59336439299c8a13e25281455abb93d1d985c7de98621bcac1bf5d4c2c4a`；Console `sha256:dcac857225d26e3f627f9fc01be2a9b6fd4140d6f966da1e0ea3fba7043ab366`、Gateway `sha256:cf9b2f2744c767a38e2c1d8181975ca34111a01a0ac8a69a9a90a46fe3800a2f`、Connector `sha256:8b237e25fffe63aeab10cd4ce209ef9826a523707101d7fdb2719cb6f430e2ce`、Diagnosis `sha256:1d3134f08e00bbb29d3366041b56c6b54299b31824c618cdeaf1f7ae7d4fe18f` 与 Notification `sha256:1a73d5d3bf8e2f95b4d2c1f229657765b78628dc2e98c68b6d405af545a50444` 均已通过 split-image/import 或 nginx smoke、推送、空 Docker config 匿名 manifest inspect 与按 digest 拉取；Console OCI revision 精确绑定完整 `1424dd5` commit。此前包括 `9528a033…81ef36` 在内的 candidate 均已被 supersede，不得继续用于 A01。builder 直连 `registry.k8s.io` 超时后，仅重建进程使用用户授权代理，Aliyun/Quay/DaoCloud 保持直连；代理未写入项目或 Cluster 配置。
