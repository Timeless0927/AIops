...
当前 live candidate（A01）：`dist/aiops-pilot-v0.1.0.tar.gz` SHA256 `c9c0e1063afb4d3a61a08d50b8207b30a0988a87426fae8416c6aa5005fb6600`；Console `sha256:9d16af2e33d63766f57239e64779338f4f8ec0f1c246ae6d355b9ea06c0c9102`、Gateway `sha256:16c3d1d4f112d6fbb7fa6eb89736a9a8dd4b29d2f9c53e6f1b057089f8107fbd`、Diagnosis `sha256:1d3134f08e00bbb29d3366041b56c6b54299b31824c618cdeaf1f7ae7d4fe18f` 与 Notification `sha256:317377822411c33ef95dd1e838d1e02909b5aa260a740ab85e351f83321f4c6e` 均已通过 split-image import smoke、推送和空 Docker config 匿名 manifest inspect；先前 `f0e10b04…0418` candidate 已被 supersede，不得继续用于 A01。直连 `registry.k8s.io` 的 kube-state-metrics manifest 首次 60s 超时后，仅重建进程使用用户授权代理，其余 registry 保持直连；代理未写入项目或 Cluster 配置。
