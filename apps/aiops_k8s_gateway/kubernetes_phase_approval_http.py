...
def dispatch(
    ...
    if admin_id is not False:
        return _dispatch_admin(
            handler, admin_id, sessions, authorities, authorize_admin, require_fresh_auth,
...
def _dispatch_admin(
    ...
    try:
        ...
        _admin_denial(
            sessions, session.actor.actor_id, target, exc.code, request_id,
        ...
        _admin_denial(
            sessions, session.actor.actor_id, target, "invalid_request", request_id,
