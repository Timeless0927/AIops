...
def main() -> None:
    ...
    notification_requests.start_notification_handoff(notification_requests.NotificationOutbox(_SESSIONS.database), sender=notification_handoff_http.send_notification_request)
