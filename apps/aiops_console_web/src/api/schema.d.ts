...
export interface paths {
    ...
    "/api/v1/chat/sessions/{id}/events": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/chat/sessions/{id}/events/stream": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
...
export interface components {
    schemas: {
        ...
        ChatSessionResponse: {
            request_id: string;
            chat_session: components["schemas"]["ChatSession"];
        };
...
export interface operations {
    ...
    listChatSessions: {
        ...
        requestBody?: never;
        responses: {
            /** @description Creator-private Chat Sessions */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    createChatSession: {
        ...
        responses: {
            /** @description Private Chat Session created */
            201: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    getChatSession: {
        ...
        requestBody?: never;
        responses: {
            /** @description Creator-private Chat Session and messages */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    listChatEvents: {
        ...
        requestBody?: never;
        responses: {
            /** @description Durable Chat event page */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["ChatEventsResponse"];
                };
            };
            400: components["responses"]["Error"];
            401: components["responses"]["Error"];
    ...
    streamChatEvents: {
        ...
        requestBody?: never;
        responses: {
            /** @description Creator-private replayable Chat event stream */
            200: {
                headers: {
                    [name: string]: unknown;
                };
