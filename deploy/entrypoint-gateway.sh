...
export AIOPS_DIAGNOSIS_URL="${AIOPS_DIAGNOSIS_URL:-${AIOPS_HERMES_URL:-http://diagnosis:8082}}"
export AIOPS_DIAGNOSIS_PATH="${AIOPS_DIAGNOSIS_PATH:-${AIOPS_HERMES_DIAGNOSIS_PATH:-/diagnosis/sessions}}"
