...
export FEISHU_APPROVAL_ENABLED="${FEISHU_APPROVAL_ENABLED:-false}"
export FEISHU_APPROVAL_POLLING_ENABLED="${FEISHU_APPROVAL_POLLING_ENABLED:-false}"
export FEISHU_APPROVAL_FORM_MODE="${FEISHU_APPROVAL_FORM_MODE:-legacy_fields}"
export FEISHU_APPROVAL_SUMMARY_FIELD_ID="${FEISHU_APPROVAL_SUMMARY_FIELD_ID:-}"
export FEISHU_APPROVAL_DETAIL_FIELD_ID="${FEISHU_APPROVAL_DETAIL_FIELD_ID:-}"
export FEISHU_APPROVAL_SOURCE_FIELD_ID="${FEISHU_APPROVAL_SOURCE_FIELD_ID:-}"
export FEISHU_APPROVAL_INCIDENT_ID_FIELD_ID="${FEISHU_APPROVAL_INCIDENT_ID_FIELD_ID:-}"
export FEISHU_APPROVAL_RISK_LEVEL_FIELD_ID="${FEISHU_APPROVAL_RISK_LEVEL_FIELD_ID:-}"
export FEISHU_APPROVAL_COMMAND_FIELD_ID="${FEISHU_APPROVAL_COMMAND_FIELD_ID:-}"
export FEISHU_APPROVAL_NAMESPACE_FIELD_ID="${FEISHU_APPROVAL_NAMESPACE_FIELD_ID:-}"
export FEISHU_APPROVAL_REASON_FIELD_ID="${FEISHU_APPROVAL_REASON_FIELD_ID:-}"
...
required_envs=(
  ...
  FEISHU_APPROVAL_REQUESTER_OPEN_ID
  FEISHU_APPROVAL_APPROVER_NODE_KEY
...
case "$FEISHU_APPROVAL_FORM_MODE" in
  legacy_fields|mapped_fields)
    required_form_envs=(
      FEISHU_APPROVAL_SOURCE_FIELD_ID
      FEISHU_APPROVAL_INCIDENT_ID_FIELD_ID
      FEISHU_APPROVAL_RISK_LEVEL_FIELD_ID
      FEISHU_APPROVAL_COMMAND_FIELD_ID
      FEISHU_APPROVAL_NAMESPACE_FIELD_ID
      FEISHU_APPROVAL_REASON_FIELD_ID
    )
    ;;
  summary_detail)
    required_form_envs=(
      FEISHU_APPROVAL_SUMMARY_FIELD_ID
      FEISHU_APPROVAL_DETAIL_FIELD_ID
    )
    ;;
  *)
    echo "unsupported FEISHU_APPROVAL_FORM_MODE: $FEISHU_APPROVAL_FORM_MODE" >&2
    exit 1
    ;;
esac
for env_name in "${required_form_envs[@]}"; do
  if [[ -z "${!env_name:-}" ]]; then
    echo "missing required env: $env_name" >&2
    exit 1
  fi
...
keys = [
    ...
    "FEISHU_APPROVAL_APPROVER_NODE_KEY",
    "FEISHU_APPROVAL_APPROVER_OPEN_ID",
    "FEISHU_APPROVAL_POLLING_ENABLED",
    "AIOPS_SRE_ADMIN_NAME",
    "AIOPS_SRE_ADMIN_OPEN_ID",
    "AIOPS_SRE_OPERATOR_NAME",
    "AIOPS_SRE_OPERATOR_OPEN_ID",
